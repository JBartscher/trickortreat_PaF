...
class MapGenerator {
    ...
    void createTownHall(int x, int y) {
        ...
        try {
            District districtOfHouse = districtManager.getDistrict(townHall.placeable);
    ...
    void createSmallHouses(int numberOfHouses) {
        ...
        for (int i = 0; i < numberOfHouses; i++) {
            ...
            // put the right district to the house object
            try {
                District districtOfHouse = districtManager.getDistrict(smallHouse.placeable);
    ...
    void createBigHouses(int numberOfHouses) {
        ...
        for (int i = 0; i < numberOfHouses; i++) {
            ...
            // put the right district to the house object
            try {
                District districtOfHouse = districtManager.getDistrict(bigHouse.placeable);
